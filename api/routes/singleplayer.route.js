...
router.get("/", middleware, SinglePlayerController.index);

router.get("/word", SinglePlayerController.word_get);

router.post("/word", SinglePlayerController.word_post);

router.get("*", SinglePlayerController.word_not_found);
